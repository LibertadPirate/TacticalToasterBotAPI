...
public class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        Traverse.Create(typeof(BotSettingsRepoClass)).Field<Dictionary<WildSpawnType, GClass790>>("dictionary_0").Value.Add((WildSpawnType)UNTAREnums.BotUNTARValue, new GClass790(true, true, false, $"ScavRole/{UNTAREnums.BotUNTARRole}", (ETagStatus)0));*/
